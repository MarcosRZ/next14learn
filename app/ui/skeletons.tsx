  ...
  return (
    ...
    >
      <div className="flex p-4">
        ...
        <div className="ml-2 h-6 w-16  bg-gray-200 text-sm font-medium" />
      </div>
    ...
    <div className="flex flex-row items-center justify-between border-b border-gray-100 py-4">
      <div className="flex items-center">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-2 h-4 w-12  bg-gray-200" />
        </div>
      </div>
      <div className="mt-2 h-4 w-12  bg-gray-200" />
    </div>
...
export function LatestInvoicesSkeleton() {
  return (
    ...
    >
      <div className="mb-4 h-8 w-36  bg-gray-100" />
      <div className="flex grow flex-col justify-between  bg-gray-100 p-4">
...
export default function DashboardSkeleton() {
  return (
    <>
      <div
        className={`${shimmer} relative mb-4 h-8 w-36 overflow-hidden  bg-gray-100`}
      />
